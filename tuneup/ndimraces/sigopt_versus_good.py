from tuneup.ndimhorserace import latex_horse_race
from tuneup.ndimsingleobjectives.ndimboxobjectives import OBJECTIVES
from tuneup.ndimsolvers.ndimboxsolvers import OPEN_SOURCE_SOLVERS, VENDOR_SOLVERS
...
def race_specification(debug:bool):
    ...
    spec = {'objectives': objectives,
            ...
            'n_dim':10,
            'solvers_for_thresholds': OPEN_SOURCE_SOLVERS}
    return spec
